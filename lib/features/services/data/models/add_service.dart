...
class AddServiceModel extends AddService {
  const AddServiceModel({
    ...
    required String startSaturday,
    required String endSaturday,
    required String startSunday,
    required String endSunday,
    required String startMonday,
    required String endMonday,
    required String startTuesday,
    required String endTuesday,
    required String startWednesday,
    required String endWednesday,
    required String startThursday,
    required String endThursday,
    required String startFriday,
    required String endFriday,
  }) : super(
          id: id,
